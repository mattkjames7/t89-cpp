...
void t89(    
    int iopt, double *parmod, double psi,
    ...
    t89tailClosureCurrent(
        x, y, z,
        AmpClsSym, AmpClsAsym, sps,
        &BxTc, &ByTc, &BzTc
    );
...
void t89tailCurrentSheetShape(    
    double xsm, double ysm, 
...
void t89cfClosureCurrent(    
    double x, double y, double z, double deltax,
